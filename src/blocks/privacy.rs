...
const TYPE_ICONS: [(Type, &str, &str); 5] = [
    (Type::Audio, "icon_audio", icons::MICROPHONE),
    (Type::AudioSink, "icon_audio_sink", icons::VOLUME),
    (Type::Video, "icon_video", icons::XRANDR),
    (Type::Webcam, "icon_webcam", icons::WEBCAM),
    (Type::Unknown, "icon_unknown", icons::UNKNOWN),
];
