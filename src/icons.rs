...
lazy_static! {
    ...
    pub static ref AWESOME: Map<String, String> = map_to_owned! {
        ...
        "bat_charging" => " \u{f1e6} ", // plug
        "bat_discharging" => " \u{f242} ", // battery-half
        "bat_empty" => " \u{f244} ", // battery-empty
        "bat_full" => " \u{f240} ", // battery-full
        "bat_half" => " \u{f242} ", // battery-half
        "bat_not_available" => " \u{f244} ", // battery-empty
        "bat_quarter" => " \u{f243} ", // battery-quarter
        "bat_three_quarters" => " \u{f241} ", // battery-three-quarters
        "bell" => " \u{f0f3} ", // bell
        "bell-slash" => " \u{f1f7} ",
        "bluetooth" => " \u{f294}", // bluetooth-b
        "calendar" => " \u{f073} ", // calendar-alt
        "cogs" => " \u{f085} ", // cogs
        "cpu" => " \u{f0e4} ",
        "disk_drive" => " \u{f0a0} ", // hdd
        "docker" => " \u{f21a} ", // ship
        "github" => " \u{f09b} ", // github
        "gpu" => " \u{f26c} ", // tv
        "headphones" => " \u{f025}", // headphones
        "joystick" => " \u{f11b}", // gamepad
        "keyboard" => " \u{f11c}", // keyboard
        "mail" => " \u{f0e0} ", // envelope
        "memory_mem" => " \u{f2db} ", // microchip
        "memory_swap" => " \u{f0a0} ", // hdd
        "mouse" => " \u{f245}", // mouse-pointer
        "music" => " \u{f001} ", // music
        "music_next" => " \u{f061} ", // arrow-right
        "music_pause" => " \u{f04c} ", // pause
        "music_play" => " \u{f04b} ", // play
        "music_prev" => " \u{f060} ", // arrow-left
        "net_bridge" => " \u{f0e8} ", // sitemap
        "net_down" => " \u{2b07} ",
        "net_loopback" => " LO ",
        "net_modem" => " \u{f095} ", // phone
        "net_up" => " \u{2b06} ",
        "net_vpn" => " \u{f023} ", // lock
        "net_wired" => " \u{f0ac} ", // globe
        "net_wireless" => " \u{f1eb} ", // wifi
        "notification" => " \u{f0a2} ",
        "phone" => " \u{f10b} ",
        ...
        "tasks" => " \u{f0ae} ",
        "thermometer" => " \u{f2c8} ", // thermometer-three-quarters
        "time" => " \u{f017} ", // clock
        "toggle_off" => " \u{f204} ", // toggle-off
        "toggle_on" => " \u{f205} ", // toggle-on
        "unknown" => " \u{f128} ", // question
        "update" => " \u{f062} ", // Same as time symbol.
        "uptime" => " \u{f017} ", // clock
        "volume_empty" => " \u{f026} ", // volume-off
        "volume_full" => " \u{f028} ", // volume-up
        "volume_half" => " \u{f027} ", // volume-down
        "volume_muted" => " \u{f026} \u{f00d} ",
        "microphone_empty" => " \u{f130} ", // microphone
        "microphone_full" => " \u{f130} ", // microphone
        "microphone_half" => " \u{f130} ", // microphone
        "microphone_muted" => " \u{f131} ", // microphone-slash
        "weather_clouds" => " \u{f0c2} ", // cloud
        "weather_default" => " \u{f0c2} ", // cloud
        "weather_rain" => " \u{f043} ", // tint
        "weather_snow" => " \u{f2dc} ", // snowflake
        "weather_sun" => " \u{f185} ", // sun
        "weather_thunder" => " \u{f0e7} ", // bolt
        "xrandr" => " \u{f26c} " // tv
    };
